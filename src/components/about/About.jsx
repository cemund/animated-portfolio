    ...
    <section class="about" id="about" name="learn-more">
      ...
      >
        ...
        <motion.div variants={variants} className="links">
          <motion.a
            href="https://www.linkedin.com/in/cemund-malagar"
            target="_blank"
            whileHover={{
              scale: 20,
              rotate: 30,
